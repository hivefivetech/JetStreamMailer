    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto pt-10 px-4 md:px-8 lg:px-10">
                <h2 className="text-2xl md:text-4xl mb-4 text-black max-w-4xl font-bold">
                ...
                {data.map((item, index) => (
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            ...
                            <h3 className="hidden md:block text-xl md:pl-20 md:text-2xl font-bold text-neutral-900">
                                {item.title}
                            </h3>
                        </div>
